...
**"[IEEE TII] Balancing Discrepancy and Consistency: Adversarial Single Domain Generalization in Fault Diagnosis"**.[Paper Link](https://ieeexplore.ieee.org/document/11076159) 
